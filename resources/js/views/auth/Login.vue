                ...
                <div class="row justify-content-center">
                    <div class="col-lg-6 col-md-6 d-flex flex-column align-items-center justify-content-center">
                        <div class="card mb-3">
                            <div class="card-body p-4">
                                ...
                                <div class="mt-5 mb-5">
                                    ...
                                    <p class="text-center text-base">Enter your email & password to log in</p>
                                </div>
                                ...
                                <form class="row g-3 needs-validation d-flex justify-center" novalidate>
                                    ...
                                    <div class="col-10">
                                        <div class="d-flex justify-content-end">
                                            <router-link :to="{name: 'dashboard'}" style="font-weight: bold;">
                                                Forgot Password ?
                                            </router-link>
                                        </div>
                                    </div>
                        ...
                        <div class="credits mt-5">
                            <span class="text-white">v0.0.1 &#169; 2022</span>
                        </div>
                    </div>
                </div>
            </div>
